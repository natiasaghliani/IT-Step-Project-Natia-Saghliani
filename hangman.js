...
// runHangman(); html დან ვიძახებთ, ღილაკზე დაჭერით
...
function runHangman() {
  ...
  while (true) {
    ...
    let charToGuess = prompt(
      `Guess the world ${wordToGuessAsArray.join(
        " "
      )}, attempts remainig ${countAttempts}`
    );
